...
class RateCalculatorServiceTest {
    ...
    void 금리가_없는_청약상품은_금리비교_대상에서_제외한다() {
        ...
        ReflectionTestUtils.setField(product, "keywords", new ArrayList<>(List.of(keyword)));
        ReflectionTestUtils.setField(product, "properties", new ArrayList<>(List.of(new ProductProperty())));
